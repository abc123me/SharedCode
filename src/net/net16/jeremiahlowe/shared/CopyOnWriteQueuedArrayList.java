...
public class CopyOnWriteQueuedArrayList<T> implements Iterable<T> {
	private CopyOnWriteArrayList<T> base;
	private ArrayList<T> toRemove, toAdd;
	private Comparator<T> sorter;

	public CopyOnWriteQueuedArrayList() {
		this(null);
	}
	public CopyOnWriteQueuedArrayList(Comparator<T> sorter) {
		base = new CopyOnWriteArrayList<T>();
